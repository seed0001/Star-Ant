# Episode 14 — The Trees

- Season: 2 · The Flora
- Runtime target: ~7.5 min (~1000 words)
- Voice: en-US-AndrewMultilingualNeural

## Cold open

[SHOT: low tree — from the roots, the camera tilts up a colossal trunk into the crown]

In a world where grass stands over a meter tall, it takes ambition to be called a giant. These qualify.
