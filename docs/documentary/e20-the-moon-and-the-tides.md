# Episode 20 — The Moon and the Tides
...
[SHOT: wide sky — clouds slide across the moon; the silver lane on the lake goes out]

But the sky does not always keep such gentle company. There are nights when the roof forgets its manners entirely — when the window closes, and the dome turns to noise and fire.

[SHOT: cutaway lightning — a bolt tears the dark; one violent frame of white]

Rain, snow, and the sky's own artillery. Next: the Weather.
